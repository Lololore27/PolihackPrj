      ...
      <v-row justify="center" align="center">
        ...
        <v-col cols="12" md="8">
          <v-card class="bg-deep-purple-lighten-2">
            <v-card-title class="bg-deep-purple-lighten-2 text-h5 text-center">Please share one thing you've 
                <br> done recently and you've enjoyed</v-card-title>
            ...
            <v-card-text>
              ...
              <v-radio-group v-model="selectedOption" column>
                <v-radio label="Practice one of my hobbies" value="option_one"></v-radio>
