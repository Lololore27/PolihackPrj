      ...
      <v-card>
        ...
        <v-card-text>
          <v-form ref="form" v-model="formValid">
            <!-- Title Input -->
            <v-text-field v-model="post.title" label="Title" variant="filled" :rules="[rules.required]"></v-text-field>

            <!-- Content Input -->
            <v-textarea v-model="post.content" label="Text" variant="filled" :rules="[rules.required]"></v-textarea>
        ...
        <v-card-actions>
          ...
          <v-btn color="success" :disabled="!formValid" @click="submitPost">
            Post
          </v-btn>
        </v-card-actions>
      </v-card>
